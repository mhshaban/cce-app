...
2. افتح بطولة حالتها `Running` وفئة قيد التحكيم على جهازين: الأول في Judge Panel يسجل نتائج، والثاني في Live Results بنفس الفئة. يجب أن يظهر الترتيب الجديد في لوحة Live Results خلال ثوانٍ قليلة دون إعادة تحميل يدوية.
3. تحقق أن التحديث التلقائي يتوقف عند الانتقال إلى صفحة أخرى في التطبيق (لا طلبات Supabase إضافية في الخلفية)، ويستأنف فور العودة إلى Live Results.
4. اختبر وضع Big Screen: يجب أن يكبّر الترتيب ويخفي المحددات وأزرار الإجراءات، وأن يعمل زر الخروج منه لاستعادة العرض العادي.
5. اقطع الشبكة مؤقتًا أثناء عرض Live Results: يجب أن يظهر تحذير تحديث فوق آخر ترتيب معروف دون مسحه، ويختفي التحذير بعد نجاح التحديث التالي.
