...
async function backupObject(){
  ...
  return window.CCE.backupRuntime.createJsonBackup({app:'Country Club Equestrian',version:'4.15.0',created_at:new Date().toISOString(),income,expenses,horses,breeding,schedule:schedule_data,instructors:instructors_data,booking_requests,audit_logs:readAuditLog()});
}
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    navigator.serviceWorker.register('./sw.js?v=20260728-4150', {scope:'./'})
      .then(reg => {
