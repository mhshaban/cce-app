...
-- Drops the added columns. Emergency use only — any add-on selections
-- staff have recorded will be lost; the printed livery contract falls back
-- to showing "None selected" for Extra Care Add-ons and Feed Selection,
-- identical to pre-v4.25.0 behavior. No other data is affected.
