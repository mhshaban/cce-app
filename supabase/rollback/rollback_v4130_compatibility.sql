-- CCE StableOS v4.13.0 compatibility rollback
-- Restores the Sprint 4 (v4.12.0) permission check on the judging read RPCs and
-- withdraws show_office.results.view grants. No tables, scores or history are touched.
...
where rp.role_id=r.id
  and r.code in ('super_admin','manager','judge','reception','staff')
  and rp.permission_code='show_office.results.view';
